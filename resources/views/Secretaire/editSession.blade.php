...
@method("PUT")
    ...
    <input  style="margin:10px;" type="date" class="form-control" name="date_debut"   value="{{$session->date_debut}}">
    <br>
    <label class="form-label">Temps_debut</label>
    <input  style="margin:10px;" type="time" class="form-control" name="temps_debut"  value="{{$session->temps_debut}}" >
    <br>
    <label class="form-label">Temps_fin</label>
    <input  style="margin:10px;" type="time" class="form-control" name="temps_fin"  value="{{$session->temps_fin}}" >
    <br>
    ...
    <button type="submit" class="btn btn-success my-5" name="submit">Modifier</button>
</form>
</div>
@endsection